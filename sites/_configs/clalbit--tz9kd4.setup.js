...
function escML(str){ var t=str==null?'':String(str); t=t.replace(/<br\s*\/?>/gi,'\n'); var d=document.createElement('div'); d.textContent=t; return d.innerHTML; }
for (var i = 0; i < jobs.length; i++) {
  ...
  wrap.innerHTML =
    ...
    '<div class="JobDetails">' + escML(j.JobDesc) + '</div>' +
    '<div class="WantedDesc">' + escML(j.Qualifications) + '</div>' +
